...
def load_densenet():
    ...
    NUM_CLASSES = 3  # Ajuste conforme o número de classes treinadas no seu DenseNet
...
# Ajuste os nomes das classes de acordo com a ordem treinada no seu DenseNet
classes_densenet = ["Segmentado", "Bastonete", "Outro"]
