...
def load_densenet():
    ...
    if cleaned_state_dict:
        # Carregamento seguro filtrando por formato para evitar size mismatch
...
classes_densenet = [f"Classe {i}" for i in range(num_classes_detectado)]
...
if file:
    ...
    if boxes and len(boxes) > 0:
        for box in boxes:
            ...
            class_name = classes_densenet[pred_idx.item()] if pred_idx.item() < len(classes_densenet) else "Desconhecido"
